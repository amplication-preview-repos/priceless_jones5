...
export class ContactResolverBase {
  ...
  async getUser(@graphql.Parent() parent: Contact): Promise<User | null> {
  ...
  async AddContactData(
    ...
    return this.service.AddContactData(args);
  }

  @graphql.Query(() => [Contact])
  async GetContactData(
    @graphql.Args()
    args: ContactFindManyArgs
  ): Promise<Contact[]> {
    return this.service.GetContactData(args);
  }
}
