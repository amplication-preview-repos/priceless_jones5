...
export class ContactControllerBase {
  ...
  async AddContactData(
    @common.Body()
    body: ContactFindManyArgs
  ): Promise<Contact[]> {
    return this.service.AddContactData(body);
  }

  @common.Post("/getContactData")
  @swagger.ApiOkResponse({
    type: Contact,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async GetContactData(
    ...
    return this.service.GetContactData(body);
  }
}
